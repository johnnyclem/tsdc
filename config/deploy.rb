...
GITHUB_REPOSITORY_NAME = 'tsdc'
LINODE_SERVER_HOSTNAME = '192.155.83.29'
...
set :application,                "tsdc"
set :deploy_to,                  "/var/www/apps/tsdc"
...
# SCM Options
set :scm,        :git
set :repository, "git@github.com:johnnyclem/#{GITHUB_REPOSITORY_NAME}.git"
set :branch,     "master"
